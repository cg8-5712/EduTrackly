...
export async function getStudentController(req, res) {
  try {
    ...
    logger.error('Error in getStudent controller', {
      error: {
        message: error.message,
        name: error.name,
        code: error.code,
...
export async function getStudentlistController(req, res) {
  try {
    ...
    logger.error('Error in listStudents controller', {
      error: {
        message: error.message,
        name: error.name,
        code: error.code,
...
export async function attendanceChangeController(req, res) {
  try {
    ...
    logger.error('Error in attendanceChange controller', {
      error: {
        message: error.message,
        name: error.name,
        code: error.code,
...
export async function deleteStudentController(req, res) {
  try {
    ...
    logger.error('Error in deleteStudent controller', {
      error: {
        message: error.message,
        name: error.name,
        code: error.code,
...
export async function putStudentEventController(req, res) {
  try {
    ...
    logger.error('Error in putStudentEventController', {
      error: {
        message: error.message,
        name: error.name,
        code: error.code,
